...
// This file holds a known good log file for the nestest rom
...
public:
    ...
    static void DebugInstruction(const Cpu& cpu, uint8_t opcode, uint32_t index)
    {
        ...
        if (_cmp_vector[index].substr(0,4) != str.substr(0,4))
        {
            getchar();
        }
    }
...
private:
    static constexpr std::string_view _cmp_vector[] = 
    {
